    ...
    initSwiper: function(options) {
        ...
        if ($slides.length > 1) {
            $el.each(function() {
                ...
                $el.data('swiper', slider); //Allows usage of API outside of here
        ...
        switch (paginationType) {
            ...
            case 'loader':
                var loader = function renderBullet(index) {
                    ...
                    paginationRender += '<span class="custom-pagination-number">' + (index + 1).zeroize() + '</span>';
...
// woody-component-focus tpl_130
$(".woody-component-focus.tpl_130 .swiper-container").each(function() {
    var $this = $(this);
    $this.initSwiper({
        loop: false,
        parallax: true,
